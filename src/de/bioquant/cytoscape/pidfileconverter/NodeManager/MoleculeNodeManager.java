...
public interface MoleculeNodeManager {
	...
	/**
	 * Adds the specified molecule to manager's control. if it is not already present. More formally, adds the specified element newMolecule to this
	 * manager if it contains no element e2 such that (newInteraction==null ? e2==null : newMolecule(e2)). If this manager already contains the
	 * element, the call leaves it unchanged and returns false.
	 * 
	 * @param newMolecule
	...
	/**
	 * Returns true if this manager contains the specified molecule. More formally, returns true if and only if this manager contains an element e
