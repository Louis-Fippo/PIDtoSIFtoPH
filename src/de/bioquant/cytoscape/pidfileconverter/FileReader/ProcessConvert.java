...
import de.bioquant.cytoscape.pidfileconverter.FileWriter.FileWriterBis;
...
import de.bioquant.cytoscape.pidfileconverter.FileWriter.phFileWriter;
...
public class ProcessConvert extends AbstractProcess {
	...
	public void run() {
		...
		try {
			...
			/**on va essayer de récupérer le graphe bien construit ici**/
			
			CyNetwork myNet=Cytoscape.getCurrentNetwork();
			
			 //écriture dans le format PH
	           FileWriterBis phwriter = phFileWriter.getInstance();
	           try{
	        	      
	                   phwriter.writeBis("phCode.ph", myNet);
	                   System.out.println("Hello Fippo Bis ...");
	...
	public void convertFile(String filepath) {
		...
		if (inputfilepath.endsWith("xml")) {
			...
			convertFrame.getBar().setValue(85);
			System.out.println("Bonjour Fippo...");
			
			/******* Modification pour l'écriture au format PH****
			 //modification de Fippo
			
           System.out.println("Bonjour Fippo ..."+inputfilepath);
           
          
           //écriture dans le format PH
           FileWriterBis phwriter = phFileWriter.getInstance();
           try{
                   phwriter.writeBis(inputfilepath, Net);
                   System.out.println("Hello Fippo ...");
			...
			/*****Fin des modifications pour l'écriture au format PH*/
