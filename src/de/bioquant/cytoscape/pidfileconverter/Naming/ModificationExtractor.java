...
public class ModificationExtractor {
	...
	public static String getModificationString(ComponentModification modification) {
	...
	public static String getDetailedModifactionString(ComponentModification modification) {
		StringBuffer string = new StringBuffer();
		if (modification.hasAnyModifications()) {
	...
	public static String getDetailledModificatonStringForComplexMolecules(List<CompMolMember> members,
