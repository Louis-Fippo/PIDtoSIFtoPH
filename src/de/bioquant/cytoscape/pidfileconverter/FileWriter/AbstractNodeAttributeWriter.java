...
public abstract class AbstractNodeAttributeWriter implements FileWriter {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.bioquant.cytoscape.ConnectOwlAndXmlOfPID.FileWriter.FileWriter#write(java.lang.String,
	 * de.bioquant.cytoscape.ConnectOwlAndXmlOfPID.NodeManager.NodeManagerImpl)
	 */
	@Override
	public void write(final String path, final NodeManagerImpl manager) throws FileNotFoundException {
